"""
============================================================
SWARM GENESIS v6.0 — DESINSTALADOR
...
def export_before_remove():
    ...
    try:
        ...
        export = {"exported_at": ts, "version": "6.0"}
        for t in tables:
            try:
...
def remove_claude_md_section():
    ...
    for marker in ["## SWARM GENESIS v6.0", "## SWARM GENESIS v5.0", "## SWARM GENESIS v4.0"]:
...
def main():
    print(f"\n{'='*60}")
    print(f"  SWARM GENESIS v6.0 — Desinstalador")
    print(f"{'='*60}\n")
